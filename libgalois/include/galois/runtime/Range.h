...
public:
  ...
  local_iterator local_begin(unsigned tid) const { return container->local_begin(tid); }
  local_iterator local_end(unsigned tid) const { return container->local_end(tid); }
