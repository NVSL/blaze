...
void
SharedMemSubstrate::perfCounterStart(void) {
    m_tpool.startPerfCounter();
}

void
SharedMemSubstrate::perfCounterStop(void) {
    m_tpool.stopPerfCounter();
}

void
SharedMemSubstrate::perfCounterSummarize(void) {
    m_tpool.summarizePerfCounter();
}
#endif
